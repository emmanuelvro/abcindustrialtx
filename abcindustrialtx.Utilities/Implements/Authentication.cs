...
namespace abcindustrialtx.Utilities.Implements
{
    public class AuthenticationAbc
    {
        ...
        public static string VerificarStringHashPassword(string password, string sal, string hash)
        {
            if (GenerarHash(password, sal) == hash)
